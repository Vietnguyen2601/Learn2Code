...
public static class ExerciseMapper
{
    ...
    public static ExerciseDetailDto ToDetailDto(this Exercise exercise)
    {
        return new ExerciseDetailDto
        {
            ...
            DefaultMainCode = exercise.DefaultMainCode,
    ...
    public static Exercise ToEntity(this CreateExerciseRequest request, Guid lessonId, int orderNumber)
    {
        return new Exercise
        {
            ...
            DefaultMainCode = request.DefaultMainCode,
    ...
    public static void UpdateExercise(this Exercise exercise, UpdateExerciseRequest request, int? finalOrderNumber = null, bool clearCodeFields = false)
    {
        ...
        if (request.DefaultMainCode != null)
            exercise.DefaultMainCode = request.DefaultMainCode;
