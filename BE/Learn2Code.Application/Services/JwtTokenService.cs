...
public class JwtTokenService : IJwtTokenService
{
    ...
    public string GenerateToken(Account account, IList<string> roles)
    {
        ...
        var issuer = jwtSettings["Issuer"] ?? "Learn2Code";
        var audience = jwtSettings["Audience"] ?? "Learn2CodeUsers";
    ...
    public ClaimsPrincipal? GetPrincipalFromExpiredToken(string token)
    {
        ...
        var tokenValidationParameters = new TokenValidationParameters
        {
            ...
            ValidAudience = jwtSettings["Audience"] ?? "Learn2CodeUsers",
            ValidateIssuer = true,
            ValidIssuer = jwtSettings["Issuer"] ?? "Learn2Code",
