...
public class LessonService : ILessonService
{
    ...
    {
        // Ki?m tra section c� t?n t?i kh�ng
    ...
    public async Task<ServiceResult> ReorderLessonsAsync(Guid sectionId, ReorderLessonsRequest request)
    {
        ...
        // Ki?m tra t?t c? lessons c� thu?c section n�y kh�ng
        ...
        try
        {
            ...
            // B??C 1: Set t?t c? lessons sang order_number �m t?m th?i (tr�nh unique constraint conflict)
