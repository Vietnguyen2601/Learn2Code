...
namespace Learn2Code.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260329134124_AddValidatorMainToTestCase")]
    partial class AddValidatorMainToTestCase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.Achievement", b =>
                {
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.CourseCompletionRule", b =>
                {
                    ...
                    b.Property<decimal>("MinWeightScore")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("min_weight_score");
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.DailyStreak", b =>
                {
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.Exercise", b =>
                {
                    ...
                    b.Property<string>("SolutionValidator")
                        .HasColumnType("text")
                        .HasColumnName("solution_validator");
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.TestCase", b =>
                {
                    ...
                    b.Property<string>("ValidatorMain")
                        .HasColumnType("text")
                        .HasColumnName("validator_main");
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.UserAchievement", b =>
                {
                    b.Property<Guid>("UserAchievementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("userachievement_id");
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.UserXP", b =>
                {
                    b.Property<Guid>("UserXPId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("userxp_id");
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.UserAchievement", b =>
                {
                    b.HasOne("Learn2Code.Domain.Entities.Achievement", "Achievement")
            ...
            modelBuilder.Entity("Learn2Code.Domain.Entities.UserXP", b =>
                {
                    b.HasOne("Learn2Code.Domain.Entities.Account", "User")
                        .WithOne("UserXP")
                        .HasForeignKey("Learn2Code.Domain.Entities.UserXP", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
